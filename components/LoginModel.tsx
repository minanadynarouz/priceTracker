...
const LoginModel: React.FC<Props> = ({ onClose, onLogin }) => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            setSuccessMessage(isRegistering ? 'Registration Successful! redirecting to home page in a Second' : 'Login Successful! redirecting to home page in a Second');
